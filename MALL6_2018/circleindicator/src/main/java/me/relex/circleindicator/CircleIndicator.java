...
//                        mIndicatorBackgroundResId);
                        R.drawable.notblack_radius_square);
...
//                addView(Indicator, mIndicatorWidth, mIndicatorHeight);
                LayoutParams layoutParams= (LayoutParams) currentIndicator.getLayoutParams();
            ...
            if (selectedIndicator != null) {
                LayoutParams layoutParams= (LayoutParams) selectedIndicator.getLayoutParams();

                layoutParams.width= (int) (mIndicatorWidth+mIndicatorMargin*(1.2));
                layoutParams.height=mIndicatorHeight;
                layoutParams.leftMargin = mIndicatorMargin;
                layoutParams.rightMargin = mIndicatorMargin;
    ...
    private void addIndicator(int orientation, @DrawableRes int backgroundDrawableId,
        ...
        mIndicatorWidth=((getScreenWidth()/3)*2)/(mViewpager.getAdapter().getCount())-(mIndicatorMargin*2);

        Log.e("mIndicatorWidth","mIndicatorWidth:"+mIndicatorWidth);
