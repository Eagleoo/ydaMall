...
public class NoteItem {
	...
	public NoteItem(String content, long date, boolean alarmEnable,
			int bgColor, boolean isFileFolder, int parentFolder) {
	...
	public NoteItem(int parentFolder) {
		this("", new Date().getTime(), false, -1, false, parentFolder);
	}
