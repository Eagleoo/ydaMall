...
public class CustomPullToRefreshListView extends LinearLayout implements
		OnTouchListener {
	...
	public CustomPullToRefreshListView(Context context, AttributeSet attrs) {
		...
		header = LayoutInflater.from(context).inflate(R.layout.community_pull_to_refresh,
				null, true);
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (changed && !loadOnce) {
			...
			int dp_60 = Util.dpToPx(60);
			hideHeaderHeight = -dp_60;
