package com.mall.serving.community.view.pulltorefresh;
...
import com.mall.serving.community.view.pulltorefresh.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	/** 刷新的头 */
	private HeaderLoadingLayout header;
	...
	protected LoadingLayout createHeaderLoadingLayout(Context context,
			AttributeSet attrs) {
		header = new HeaderLoadingLayout(context);
	...
	public void setHeadTextColor(int color){
		...
		if (header!=null) {
			header.mHeaderTimeView.setTextColor(color);
			header.mHeaderTimeViewTitle.setTextColor(color);
			header.mHintTextView.setTextColor(color);
		}
	}
