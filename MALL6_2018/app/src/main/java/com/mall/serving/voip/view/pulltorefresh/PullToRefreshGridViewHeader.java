package com.mall.serving.voip.view.pulltorefresh;
...
import com.mall.serving.voip.view.pulltorefresh.ILoadingLayout.State;
import com.mall.serving.voip.view.gridview.GridViewWithHeaderAndFooter;
 ...
 * @since 2013-8-15
 */
public class PullToRefreshGridViewHeader extends PullToRefreshBase<GridViewWithHeaderAndFooter> implements OnScrollListener {
     ...
     */
    public PullToRefreshGridViewHeader(Context context, AttributeSet attrs, int defStyle) {
