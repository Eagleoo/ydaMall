package com.mall.game.chinesechess.util;
...
public class Util {
	...
	public static AssetFileDescriptor loadSoundOfGame(Context c,String fileDescription){
		System.out.println("-------load-------sound---");
		AssetManager am=c.getAssets();
		AssetFileDescriptor afd=null;
		try {
			afd=am.openFd(fileDescription);
		} catch (IOException e) {
