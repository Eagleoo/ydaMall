...
public class QuantityView extends LinearLayout implements View.OnClickListener {
    ...
    public int quantity, maxQuantity, minQuantity;
...
//        mTextViewQuantity.setOnClickListener(this);
    ...
    public void setEt(int quantity) {
        if (mTextViewQuantity != null) {
    ...
    public void onClick(View v) {
        if (v == mButtonAdd) {
            ...
            et = (EditText) inflate.findViewById(R.id.qv_et_change_qty);
