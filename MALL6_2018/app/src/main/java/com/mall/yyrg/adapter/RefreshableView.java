...
public class RefreshableView extends LinearLayout {
	...
	private void init() {
		...
		refreshView = LayoutInflater.from(mContext).inflate(
				R.layout.yyrg_refresh_top_item, null);
		// 指示器view
...
//				R.string.refresh_release_text);
	...
	private void doMovement(int moveY) {
		...
		if (lp.topMargin > 0) {
			refreshIndicatorView.setImageResource(R.drawable.ssdk_oks_ptr_ptr_up);
		} else {
			refreshIndicatorView.setImageResource(R.drawable.ssdk_oks_ptr_ptr);
		}
