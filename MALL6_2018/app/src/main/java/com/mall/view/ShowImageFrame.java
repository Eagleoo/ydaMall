...
public class ShowImageFrame extends Activity implements OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name = this.getIntent().getStringExtra("name1");
        ...
        is.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((next + 1) >= gallery.getChildCount())
                    next = 0;
                else
                    next++;
        ...
        Util.asynTask(this, "正在读取产品图集", new IAsynTask() {
            @Override
            ...
            public Serializable run() {
                String id = ShowImageFrame.this.getIntent().getStringExtra(
                        "pid1");
                Web web = new Web(Web.getImageList, "id=" + id);
                list = web.getList(ProductImage.class);
    ...
    public void onItemSelected(AdapterView<?> parent, View view,
        ...
        synchronized (ShowImageFrame.this) {
            final CustomProgressDialog dialog = Util.showProgress("正在读取中...", this);
            bmUtils.display(is, list.get(position).getBig(), new DefaultBitmapLoadCallBack<View>() {
    ...
    public boolean createReflectedImages() {
        ...
        for (ProductImage pi : list) {
            ...
            // 返回原图解码之后的bitmap对象
            Bitmap originalImage = Util.getBitmap(pi.getSma(), options);
