...
public class FaceRelativeLayout extends RelativeLayout implements OnItemClickListener, OnClickListener {
	...
	protected void onFinishInflate() {
		System.out.println("表情布局加载完毕");
		super.onFinishInflate();
		if(emojis!=null&&emojis.size()>0){       
			emojis.clear();
		}
		FaceConversionUtil fu=FaceConversionUtil.getInstace();
		fu.getFileText(context);
		emojis = fu.emojiLists;
		onCreate();
	} 
	...
	private void Init_View() {
		...
		vp_face = (ViewPager) this.findViewById(R.id.vp_contains);
		et_sendmessage = (EditText) findViewById(R.id.et_sendmessage1);
		layout_point = (LinearLayout) findViewById(R.id.iv_image);
		et_sendmessage.setOnClickListener(this);
		findViewById(R.id.btn_face).setOnClickListener(this);
		view = (RelativeLayout) findViewById(R.id.ll_facechoose);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		if (!TextUtils.isEmpty(emoji.getCharacter())) {
			...
			et_sendmessage.getText().insert(et_sendmessage.getSelectionStart(),spannableString);
		}
