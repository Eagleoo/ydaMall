 ...
 * @author Lin.~
 */
public class PostedMerchantCommentariesActivity extends Activity {
    ...
    @ViewInject(R.id.mt1)
    private MoreTextView mt1;
    @ViewInject(R.id.mt2)
    private MoreTextView mt2;
    @ViewInject(R.id.mt3)
    private MoreTextView mt3;
    @ViewInject(R.id.mt4)
    private MoreTextView mt4;
    @ViewInject(R.id.mt5)
    private MoreTextView mt5;
...
//				uploadService.setBitmaps(allUpImages);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_postmerchantcomment);
        context = this;
        ViewUtils.inject(this);

        scoreall = getscore(mt5);
        ...
        if (intent.getStringExtra("Type") != null && intent.getStringExtra("Type").equals("1")) {
            ...
            Log.e("地址", "图片地址" + face + "店家名" + name);
            topback.setText(name);
...
//									bbmm = BitmapFactory.decodeFile(list.get(1)+"");//filePath
        ...
        Bitmap bitmap = getBitmapFromResources(this, R.drawable.tianjaishizhithree);
    ...
    private float getscore(View view) {
        float score = 0;
        mt1.setImag(R.drawable.cha_1);
        mt2.setImag(R.drawable.yiban_1);
        mt3.setImag(R.drawable.haibucuo_1);
        mt4.setImag(R.drawable.henmanyi_1);
        mt5.setImag(R.drawable.qiangtuijian_1);


        switch (view.getId()) {
            case R.id.mt1:
                score = 1;
                mt1.setImag(R.drawable.cha);
                break;
            case R.id.mt2:
                score = 2;
                mt2.setImag(R.drawable.yiban);
                break;
            case R.id.mt3:
                score = 3;
                mt3.setImag(R.drawable.haibucuo);
                break;
            case R.id.mt4:
                mt4.setImag(R.drawable.henmanyi);
                score = 4;
                break;
            case R.id.mt5:
                mt5.setImag(R.drawable.qiangtuijian);
                score = 5;
                break;
        }
    ...
    @OnClick({R.id.topback, R.id.post,
            R.id.mt1, R.id.mt2, R.id.mt3, R.id.mt4, R.id.mt5})
        ...
        switch (view.getId()) {
            ...
            case R.id.post:
                ...
                if (Util.isNull(xq_content.getText().toString())) {
                    Toast.makeText(PostedMerchantCommentariesActivity.this, "请输入" + "评价" + "内容", Toast.LENGTH_LONG).show();
                ...
                if (allPhotoInfos.size() > 1) {
                    for (int i = 1; i < allPhotoInfos.size(); i++) {
                        ...
                        if (allPhotoInfos.get(i).getBitmap() != null) {
                            ...
                            ImageView logo = new ImageView(PostedMerchantCommentariesActivity.this);
    ...
    private void saveBitmaps(final List<Bitmap> images, final List<PhotoInfo> photoList) {
        Util.asynTask(PostedMerchantCommentariesActivity.this, "", new IAsynTask() {
            @Override
            public void updateUI(Serializable runData) {
                ...
                if (Type.equals("1")) {
                    PostedMerchantCommentariesActivity.this.getApplicationContext().bindService(new Intent(PostedMerchantCommentariesActivity.this, UploadService.class), uploadImageServiceConnection, Context.BIND_AUTO_CREATE);
                    Intent intent = new Intent(PostedMerchantCommentariesActivity.this, AppraiseResultsActivity.class);
                    intent.putExtra("from", "writemessage");
                    intent.putExtra("shopType", ShopType);
                    PostedMerchantCommentariesActivity.this.startActivity(intent);
                    PostedMerchantCommentariesActivity.this.finish();
                } else {
                    PostedMerchantCommentariesActivity.this.getApplicationContext().bindService(new Intent(PostedMerchantCommentariesActivity.this, UploadService.class), uploadImageServiceConnection, Context.BIND_AUTO_CREATE);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        if (position == 0) {
            if (allPhotoInfos.size() < 10) {
                ...
                Toast.makeText(this, "最多发布9张动态图片", Toast.LENGTH_SHORT).show();
            }
        } else {
            getPopupWindow();
...
//		xq_content.setBackgroundResource(R.drawable.layout_width_no_corner);
        ...
        xq_content.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (lines > 10) {
                    ...
                    if (Util.isNull(str)) {
                        Util.show("您复制的内容超过最大限制！", PostedMerchantCommentariesActivity.this);
                    }
                }
            }
        });
    ...
    private void upContent(final String filespath) {
        ...
        final CustomProgressDialog dialog = Util.showProgress("正在发布您的评论...", this);
        ...
        Util.asynTask(new IAsynTask() {
            ...
            public void updateUI(Serializable runData) {
                ...
                if (Util.isNull(runData)) {
                    Util.show("网络错误，请重试！", PostedMerchantCommentariesActivity.this);
                    return;
                }
                if ((runData + "").contains("success")) {
                    if (Type.equals("1")) {
                        Util.show("评论发布成功", PostedMerchantCommentariesActivity.this);
                    } else {
                        Util.show("动态发布成功", PostedMerchantCommentariesActivity.this);
                    }
                    ...
                    Util.show(runData + "", PostedMerchantCommentariesActivity.this);
                }
            }
    ...
    private void upload(final String id) {
        ...
        Util.asynTask(new IAsynTask() {
            ...
            public void updateUI(Serializable runData) {
                ...
                if ((runData + "").contains("success:")) {
                    Toast.makeText(PostedMerchantCommentariesActivity.this, "图片上传成功", Toast.LENGTH_SHORT).show();
...
//				String NAMESCROPE = "http://lin00123.cn/";
    ...
    private void startPopupWindow() {
        ...
        btn_pick_photo.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                uploadState = 2;
                Intent intent = new Intent(PostedMerchantCommentariesActivity.this, YYRGSelectBaskImage.class);
        ...
        show_wancheng.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                photoAdapter = new SelcctPhotoAdapter(
                        PostedMerchantCommentariesActivity.this, allPhotoInfos,
    ...
    private void deleteImage() {
        ...
        queding_tuichu.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int _80dp = Util.dpToPx(PostedMerchantCommentariesActivity.this, 80F);
                ...
                DisplayMetrics dm = new DisplayMetrics();
                getWindowManager().getDefaultDisplay().getMetrics(dm);
                int networkType = Util.getNetworkType(PostedMerchantCommentariesActivity.this);
                for (int i = 1; i < allPhotoInfos.size(); i++) {
                    ImageView imageView = new ImageView(
                            PostedMerchantCommentariesActivity.this);
                    ...
                    if (1 == networkType) {
                        ...
                        Util.show("请检查您的网络!", PostedMerchantCommentariesActivity.this);
                        return;
                    }
        ...
        if (mPagerAdapter.views != null) {
            if (mPagerAdapter.views.get(mViewPager.getCurrentItem()) != null) {
                ...
                img.setImageBitmap(BitmapFactory.decodeResource(
                        PostedMerchantCommentariesActivity.this.getResources(),
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.e("拍照返回1", "requestCode" + requestCode + "uploadState" + uploadState + "photoUri" + photoUri);
...
//			Uri uri = data.getData();
    ...
    private void savePhoto(Uri uri) {
        ...
        if (storageState.equals(Environment.MEDIA_MOUNTED)) {
            ...
            Log.e("3", uri + "");
            picPath = getPath(PostedMerchantCommentariesActivity.this, uri);
