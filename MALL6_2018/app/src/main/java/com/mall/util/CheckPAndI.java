...
public class CheckPAndI {
	...
	public static boolean isMobileNO(String mobiles, Context context) {
		Pattern p = Pattern
				.compile("^((13[0-9])|(15[^4,\\D])|(14[5,7])|(18[0-9]))\\d{8}$");
		Matcher m = p.matcher(mobiles);
		return m.matches();
	}

	public static boolean isIdentityNo(String mobiles, Context context) {
		CheckPAndI checkPAndI = new CheckPAndI();
		try {
			if (TextUtils.isEmpty(checkPAndI.IDCardValidate(mobiles))) {
				return true;
			}
