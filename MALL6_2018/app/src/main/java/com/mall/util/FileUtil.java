...
public class FileUtil {
    ...
    public static final String APPS_ROOT_DIR = getExternalStorePath() + "/Mall/";
    public static final String FILE_IMAGE = getExternalStorePath() + "/Mall/image/";
    public static final String FILE_VOICE = getExternalStorePath() + "/Mall/voice/";
    public static final String FILE_FILE = getExternalStorePath() + "/Mall/file/";
    public static final String FILE_DB = getExternalStorePath() + "/Mall/db/";
    public static final String FILE_AVATAR = getExternalStorePath() + "/Mall/avatar/";
    public static final String FILE_RICH_TEXT = getExternalStorePath() + "/Mall/richtext/";
