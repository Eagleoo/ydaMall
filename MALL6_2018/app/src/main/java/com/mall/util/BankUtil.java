...
//        String cardNumber = "6210 6768 0208 4484 923";//卡号
...
//    }
    ...
    public static Bank getBank(String bankname) {
        ...
        Bank bank = new Bank();
//        System.out.println();
        Log.e("银行卡名1", bankname + "LL");
        HashMap<String, Integer[]> hashMap = getBankId();
        String name = bankname.split("·")[0];
        Log.e("银行卡名2", name + "LL");
        ...
        bank.setId(hashMap.get(name)[0] + "");
        bank.setName(bankname);
        bank.setIntegers(hashMap.get(name));
    ...
    public static HashMap<String, Integer[]> getBankId() {
        if (hashMap == null) {
            hashMap = new HashMap<>();
            hashMap.put("中国工商银行", new Integer[]{1, R.drawable.gongshang1, R.drawable.gongshang2, R.drawable.gongshangbanner});
            hashMap.put("招商银行", new Integer[]{2, R.drawable.zhaoshang1, R.drawable.zhaoshang2, R.drawable.zhaoshangbanner});
            hashMap.put("中国建设银行", new Integer[]{3, R.drawable.jianshe1, R.drawable.jianshe2, R.drawable.jianshebanner});
            hashMap.put("中国农业银行", new Integer[]{4, R.drawable.nongye1, R.drawable.nongye2, R.drawable.nongyebanner});
            hashMap.put("中国民生银行", new Integer[]{5, R.drawable.mingsheng1, R.drawable.mingsheng2, R.drawable.mingshengbanner});
            hashMap.put("深圳发展银行", new Integer[]{6, R.drawable.szfazhan1, R.drawable.szfazhan2, R.drawable.szfazhanbanner});
            hashMap.put("上海浦发银行", new Integer[]{7, R.drawable.shpufa1, R.drawable.shpufa2, R.drawable.shpufabanner});
            hashMap.put("中国光大银行", new Integer[]{8, R.drawable.guangda1, R.drawable.guangda2, R.drawable.guangdabanner});
            hashMap.put("广东发展银行", new Integer[]{9, R.drawable.gdfazhan1, R.drawable.gdfazhan2, R.drawable.gdfazhanbanner});
            hashMap.put("东亚银行", new Integer[]{10, R.drawable.dongya1, R.drawable.dongya2, R.drawable.dongyabanner});
            hashMap.put("渤海银行", new Integer[]{11, R.drawable.bohai1, R.drawable.bohai2, R.drawable.bohaibanner});
            hashMap.put("华夏银行", new Integer[]{12, R.drawable.huaxia1, R.drawable.huaxia2, R.drawable.huaxiabanner});
            hashMap.put("交通银行", new Integer[]{13, R.drawable.jiatongbanner1, R.drawable.jiatongbanner2, R.drawable.jiatongbanner});
            hashMap.put("南京银行", new Integer[]{14, R.drawable.nianjing1, R.drawable.nianjing2, R.drawable.nianjingbanner});
            hashMap.put("兴业银行", new Integer[]{15, R.drawable.xinye1, R.drawable.xinye2, R.drawable.xinyebanner});
            hashMap.put("中国银行", new Integer[]{16, R.drawable.zhongguo1, R.drawable.zhongguo2, R.drawable.zhongguobanner});
            hashMap.put("中信银行", new Integer[]{17, R.drawable.zhongxin1, R.drawable.zhongxin2, R.drawable.zhongxinbanner});
            hashMap.put("农村商业银行", new Integer[]{18, R.drawable.nongshang1, R.drawable.nongshang2, R.drawable.nongshangbanner});
            hashMap.put("城市商业银行", new Integer[]{99, R.drawable.chengshang1, R.drawable.chengshang2, R.drawable.chengshangbanner});
            hashMap.put("中国邮政储蓄银行", new Integer[]{98, R.drawable.youzheng1, R.drawable.youzheng2, R.drawable.youzhengbanner});
