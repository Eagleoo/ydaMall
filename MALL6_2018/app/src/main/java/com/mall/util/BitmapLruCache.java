...
public class BitmapLruCache {
	 ...
	 * @param imageUrl
	 */
	public void loadImage(ImageView imageView, String imageUrl, int ResId) {
		Bitmap bitmap = null;
		...
		if (!TextUtils.isEmpty(imageUrl)) {
			new ImageDownloadTask(imageView, ResId).execute(imageUrl);
			// BitmapUtils.loadBitmap(imageUrl, imageView);
		}
	...
	class ImageDownloadTask extends AsyncTask<String, Integer, Bitmap> {
		...
		public ImageDownloadTask(ImageView imageView, int ResId) {
