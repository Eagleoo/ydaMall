...
public class MyImageView extends ImageView {
	...
	private void arithScaleRate() {
		float scaleWidth = sWidth / (float) imageWidth;
		float scaleHeight =sHeight / (float) imageHeight;
	...
	public void setImageBitmap(Bitmap bitmap) {
		...
		image = bitmap;
		this.imageHeight = bitmap.getWidth();
		this.imageWidth = bitmap.getHeight();
		// 计算适应屏幕的比例
		arithScaleRate();
		// 缩放到屏幕大小
		zoomTo(scaleRate,
	...
	private void init() {
		...
		this.sHeight = ((LMSJImageFrame) this.getContext()).screenHeight;
		this.sWidth = ((LMSJImageFrame) this.getContext()).screenWidth;
	}
	...
	public void layoutToCenter() {
		...
		// 空白区域宽高
		float fill_width = sWidth - width;
		float fill_height = sHeight - height;
