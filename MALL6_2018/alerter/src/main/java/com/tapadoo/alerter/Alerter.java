...
public final class Alerter {
    ...
    public Alerter setTitleColor(String textColor) {
        if (getAlert() != null) {
            getAlert().getTitle().setTextColor(Color.parseColor(textColor));
        }

        return this;
    }

    public Alerter setTextColor(String textColor) {
        if (getAlert() != null) {
            getAlert().getText().setTextColor(Color.parseColor(textColor));
        }
    ...
    public Alerter setIcon1Visib(int visibility) {
        if (getAlert() != null) {
            getAlert().getIvIcon1().setVisibility(visibility);
        }
